...
The microcontroller is pre-programmed as a Bluetooth keyboard, so if you download the following apps to your phone/tablet, and look for the name of your MIDI Madness Maker, you should be able to use it right away!

Android: download SynprezFM II and MIDI BLE Connect
Apple: download Garageband (and Bluetooth MIDI Connect if needed)

If you want a different code example - have a look in the [Arduino (Code)](https://github.com/v0ss3n/midimadness/tree/main/Arduino%20(code)) folder (in the sidebar).
